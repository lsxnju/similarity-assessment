...
class RegressTree(nn.Module):
    def __init__(self,in_channel,hidden_channel,depth):
        ...
        self.first_layer = nn.Sequential(
            ...
            nn.ReLU(inplace=True)   #inplace代表直接替换，有利于节省空间
        )
    ...
    @staticmethod
    # @staticmethod means don't need get a example and can directly use the function like RegressTree.get_tree_layer()
